...
bar_grouped_2 = {"type": "bar", "title": {
    "text": "Percentage of pupils meeting the expected standard in mathematics by ethnicity and gender"},
                 ...
                 "yAxis": {"title": {"text": ""}}, "series": [{"name": "Boys", "data": [
        {"y": 73, "category": "Asian", "text": "number"}, {"y": 69, "category": "Black", "text": "number"},
        {"y": 88, "category": "Chinese", "text": "number"}, {"y": 72, "category": "Mixed", "text": "number"},
        {"y": 72, "category": "White", "text": "number"}, {"y": 70, "category": "Other", "text": "number"}]},
                                                              {"name": "Girls", "data": [
...
bar_grouped_source_2 = {"data": [
    ["Measure", "Time", "Time_type", "Region", "Local Authority", "LA Code", "Ethnicity", "Ethnicity type", "Gender",
     "Gender_type", "Value", "% higher standard"], [
        "% of pupils reaching the key stage 1 expected standard in mathematics by ethnicity, free school meal eligibility and gender",
