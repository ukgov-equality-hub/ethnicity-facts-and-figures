...
def test_create_dimension_on_measure_page(stub_measure_page):
    ...
    dimension_service.create_dimension(
        stub_measure_page, title="test-dimension", time_period="time_period", summary="summary", ethnicity_category=""
    )
...
def test_add_or_update_dimensions_to_measure_page_preserves_order(stub_measure_page):
    ...
    d1 = dimension_service.create_dimension(
        stub_measure_page, title="test-dimension-1", time_period="time_period", summary="summary", ethnicity_category=""
    )

    d2 = dimension_service.create_dimension(
        stub_measure_page, title="test-dimension-2", time_period="time_period", summary="summary", ethnicity_category=""
    )
