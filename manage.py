...
def sync_categorisations():
    categorisation_service.synchronise_categorisations_from_file("./application/data/static/ethnicity_categories.csv")
    categorisation_service.synchronise_values_from_file("./application/data/static/ethnicity_categorisation_values.csv")
