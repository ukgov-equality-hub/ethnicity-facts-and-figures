"""Drop the "published" boolean field from measure_version table as it is redundant

Revision ID: 2019_04_16_drop_published_bool
...
revision = "2019_04_16_drop_published_bool"
...
def downgrade():
    ...
    op.add_column(
        "measure_version",
        sa.Column("published", sa.BOOLEAN(), autoincrement=False, nullable=False, server_default="FALSE"),
    )
    op.execute(
