...
def upgrade():
    ...
    op.alter_column('frequency_of_release', 'description',
    ...
    op.create_foreign_key('secondary_source_1_type_of_statistic_fkey', 'page', 'type_of_statistic',
                          ['secondary_source_1_type_of_statistic_id'], ['id'])

    op.add_column('page', sa.Column('secondary_source_2_type_of_statistic_id', sa.Integer(), nullable=True))
    op.create_foreign_key('secondary_source_2_type_of_statistic_fkey', 'page', 'type_of_statistic',
                          ['secondary_source_2_type_of_statistic_id'], ['id'])
