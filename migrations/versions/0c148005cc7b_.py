...
def upgrade():
    ...
    op.create_foreign_key('page_parent_guid_version_fkey', 'page', 'page', ['parent_guid', 'parent_version'],
                          ['guid', 'version'])

    op.create_primary_key('upload_pkey', 'upload', ['guid'])
    op.create_foreign_key('upload_page_id_version_fkey', 'upload', 'page', ['page_id', 'page_version'],
                          ['guid', 'version'])

    op.create_primary_key('dimension_pkey', 'dimension', ['guid'])
    op.create_foreign_key('dimension_page_id_version_fkey', 'dimension', 'page',
                          ['page_id', 'page_version'], ['guid', 'version'])
