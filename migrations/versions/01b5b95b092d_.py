...
class SecondarySources(Base):
    ...
    secondary_source_1_publisher = sa.Column(sa.TEXT)
    secondary_source_1_frequency = sa.Column(sa.TEXT)

    secondary_source_2_publisher = sa.Column(sa.TEXT)
...
def upgrade():
    ...
    for s in session.query(SecondarySources):
        ...
        if s.secondary_source_1_publisher:
            secondary_source_1_publisher_id = organisation_map.get(s.secondary_source_1_publisher)
        else:
        ...
        if s.secondary_source_2_publisher:
            secondary_source_2_publisher_id = organisation_map.get(s.secondary_source_2_publisher)
        else:
