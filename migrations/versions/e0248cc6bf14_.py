...
def upgrade():
    ...
    uk_country_types = sa.Enum('ENGLAND', 'WALES', 'SCOTLAND', 'NORTHERN_IRELAND', name='uk_country_types')
    ...
    op.execute('''UPDATE page 
                  SET area_covered = '{"ENGLAND","WALES","SCOTLAND","NORTHERN_IRELAND"}'
...
def downgrade():
    ...
    op.execute('''UPDATE page 
                  ...
                  WHERE area_covered = '{"ENGLAND","WALES","SCOTLAND","NORTHERN_IRELAND"}';
               ''')
