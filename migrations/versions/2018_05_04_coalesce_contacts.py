...
def downgrade():
    ...
    op.add_column(
        "page", sa.Column("secondary_source_1_contact_1_email", sa.TEXT(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "page", sa.Column("secondary_source_1_contact_1_phone", sa.TEXT(), autoincrement=False, nullable=True)
    )
    op.add_column("page", sa.Column("secondary_source_1_contact_2_name", sa.TEXT(), autoincrement=False, nullable=True))
    op.add_column(
        "page", sa.Column("secondary_source_1_contact_2_email", sa.TEXT(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "page", sa.Column("secondary_source_1_contact_2_phone", sa.TEXT(), autoincrement=False, nullable=True)
    )
