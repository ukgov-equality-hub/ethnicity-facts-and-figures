INSERT INTO page (guid, title, uri, page_type, description, additional_description, version, created_at, parent_guid, parent_version, db_version_id)
    VALUES ('subtopic_testingspace_rdu', 'RDU testing space', 'rdu-test-space', 'subtopic', 'RDU testing space', '', '1.0', now(), 'topic_testingspace', '1.0', 1),
           ('subtopic_testingspace_moj', 'MoJ testing space', 'moj-test-space', 'subtopic', 'MoJ testing space', '', '1.0', now(), 'topic_testingspace', '1.0', 1),
           ('subtopic_testingspace_examples', 'Examples', 'test-space-examples', 'subtopic', 'Example measures', '', '1.0', now(), 'topic_testingspace', '1.0', 1);
