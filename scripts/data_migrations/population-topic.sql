...
INSERT INTO page (guid, title, uri, page_type, description, version, created_at, db_version_id, parent_guid, parent_version, position)
    VALUES ('subtopic_national_and_regional_populations', 'National and regional populations', 'national-and-regional-populations', 'subtopic', 'National and regional populations', '1.0', now(), 1, 'topic_population', '1.0', 0),
           ('subtopic_demographics', 'Demographics', 'demographics', 'subtopic', 'Demographics', '1.0', now(), 1, 'topic_population', '1.0', 0);