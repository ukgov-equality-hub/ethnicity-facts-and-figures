...
from wtforms import (
    StringField, TextAreaField, RadioField, HiddenField, SelectMultipleField, widgets
)
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.area_covered.data == ['UKCountry.UK']:
            self.area_covered.data = [
                'UKCountry.ENGLAND', 'UKCountry.NORTHERN_IRELAND', 'UKCountry.SCOTLAND', 'UKCountry.WALES'
            ]
