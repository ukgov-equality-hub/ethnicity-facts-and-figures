  ...
  function postChartObject (chartObject, src) {
    if (chartObject) {
      ...
      $.ajax({
        ...
        dataType: 'json',
        data: JSON.stringify({ 'chartObject': chartObject,
          'source': src,
          'chartBuilderVersion': 2,
    ...
    switch (chartType) {
      ...
      case 'component_chart':
        ...
        if (dataStyle === 'ethnicity_as_sections') {
          return {
            ...
            'bar_column': $('#component__bar_column').val(),
            'bar_order': $('#component__bar_order').val()
          }
        } else {
          return {
            'data_style': dataStyle,
            'section_column': $('#component__section_column').val(),
      ...
      case 'panel_bar_chart':
        ...
        if (dataStyle === 'ethnicity_as_panels') {
          return {
            'data_style': dataStyle,
            'bar_column': $('#panel-bar__bar_column').val(),
            'bar_order': $('#panel-bar__bar_order').val()
          }
        } else {
          return {
            'data_style': dataStyle,
            'panel_column': $('#panel-bar__panel_column').val(),
